...
root=Tk()
root.title("Drawing Shapes with Colors")
...
dropdown1 = ttk.Combobox(root, state="readonly", values=fillcolour, textvairbale=selectedval, width=10)
dropdownmenu = [10,50,100,200,300,400,500,600,700,800,900]
selectedval = StringVar()
dropdown2 = ttk.Combobox(root, state="readonly", values=dropdownmenu, textvariable=selectedval, width=10)
dropdownmenu1 = [10,50,100,200,300,400,500,600,700,800,900]
selectedval2 = StringVar()
dropdown3 = ttk.Combobox(root, state="readonly", values=dropdownmenu1, textvariable=selectedval, width=10)
dropdownmenu2 = [10,50,100,200,300,400,500,600,700,800,900]
selectedval3 = StringVar()
dropdown4 = ttk.Combobox(root, state="readonly", values=dropdownmenu2, textvariable=selectedval, width=10)
dropdownmenu3 = [10,50,100,200,300,400,500,600,700,800,900]
selectedval4 = StringVar()
dropdown5 = ttk.Combobox(root, state="readonly", values=dropdownmenu3, textvariable=selectedval, width=10)
